    ...
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="programme-infos-1 text-center">
                    ...
                    <div class="boutton">
                        @php
                            ...
                            if (app()->getLocale() == 'en') {
                                $href =
                                    'https://drive.google.com/file/d/1iIpycTtR3POdFtjkw2KK3hfJZQfWCt9G/view?usp=sharing';
                            }
                        @endphp
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="programme-infos-2" data-trn="content" data-trn-html>
                    <p>
                        <b class="text-white">AFRICA ART GOLF CUP</b>,
                        {{ __('tournois.intro') }}
                    </p>
                    <p>
