...
class HomeController extends Controller
{
    public function index()
    {
        return view('back.home', [
            ...
            'state' => 'back',
            'description' => 'Découvrez l\'Africa Art Golf Cup, un événement unique qui allie l\'art et le golf pour soutenir les autistes adultes. Rejoignez-nous pour une expérience inoubliable de sport, culture et solidarité.',
